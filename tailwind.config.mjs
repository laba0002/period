...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        dropred: "5px 6px 7px 0px rgba(231, 35, 45, 0.6)",
        innerred: "inset 0 2px 4px rgba(231, 35, 45, 0.6)",
        dropblue: "5px 6px 7px 0px rgba(0, 0, 250, 0.3)",
        innerblue: "inset 0 2px 4px rgba(0, 0, 250, 0.3)",
      },
    },
  },
